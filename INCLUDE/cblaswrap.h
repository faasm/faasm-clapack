/*
 * This is a hack to get the right prefixes on cblas_ functions
 * expected as part of the cblas interface
 */

#ifndef __CBLASWRAP_H
#define __CBLASWRAP_H

/* BLAS1 routines */
#define srotg_ cblas_srotg
#define crotg_ cblas_crotg
#define drotg_ cblas_drotg
#define zrotg_ cblas_zrotg
